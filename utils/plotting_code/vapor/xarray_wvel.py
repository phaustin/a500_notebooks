...
# <div class="toc"><ul class="toc-item"><li><ul class="toc-item"><li><span><a href="#First-load-a-couple-of-utility-functions" data-toc-modified-id="First-load-a-couple-of-utility-functions-0.1"><span class="toc-item-num">0.1&nbsp;&nbsp;</span>First load a couple of utility functions</a></span></li></ul></li><li><span><a href="#Conditional-sampling-the-flux" data-toc-modified-id="Conditional-sampling-the-flux-1"><span class="toc-item-num">1&nbsp;&nbsp;</span>Conditional sampling the flux</a></span></li><li><span><a href="#writing-a-vapor-vdf-file" data-toc-modified-id="writing-a-vapor-vdf-file-2"><span class="toc-item-num">2&nbsp;&nbsp;</span>writing a vapor vdf file</a></span></li></ul></div>
